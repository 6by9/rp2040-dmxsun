...
class LocalDmx {
  ...
  private:
    ...
    void wavetable_write_bit(int port, uint16_t** table, uint8_t value, uint16_t port_mask);
    void wavetable_write_byte(int port, uint16_t** table, uint8_t value, uint16_t port_mask);
};
